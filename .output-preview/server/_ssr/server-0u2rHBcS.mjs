...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bflqld6W.mjs");
...
var ROUTER_BASEPATH = "/nurselink-connect";
var SERVER_FN_BASE = "/nurselink-connect/_serverFn/";
